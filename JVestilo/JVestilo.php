<?php
// JVestilo.php — Framework CSS tipo Tailwind generado dinámicamente con PHP
// Genera clases utilitarias para colores, tamaños, flex, grid, bordes y tipografía
  include "colores.php";
